    ...
    <>
      <Stack.Screen
        options={{
          title: 'Members',
          headerRight: () =>
            Platform.OS === 'ios' ? <HeaderButton label="Invite" onPress={goInvite} /> : undefined,
        }}
      />
      <Screen>
        {Platform.OS === 'ios' ? (
            ...
            members.map((m, i) => {
              ...
              return (
                <Row
                  ...
                  leading={<Glyph bg={T.primary} ch={initial} size={Platform.OS === 'ios' ? 32 : 40} />}
                  title={m.name ?? '(unnamed device)'}
                  subtitle={
                    <Text style={{ color: T.textMuted, fontSize: 13 }}>
                      <ShortId id={m.deviceId} label="deviceId" size="xs" />
