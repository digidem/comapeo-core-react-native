      ...
      <Screen>
        ...
        <Section header="What you'll get">
          ...
          <Row
            leading={
              <Glyph
                bg={isCoordinator ? "#0891B2" : "#6B7280"}
                ch="M"
                size={30}
                radius={7}
              />
          ...
          <Row
            ...
            leading={
              <Glyph
                bg={isCoordinator ? "#A16207" : "#6B7280"}
                ch="⚙"
                size={30}
                radius={7}
              />
            ...
            subtitle={
              isCoordinator ? "Edit name, color, description" : "View only"
            }
            showChevron={false}
          />
        </Section>
        ...
        <Section header="Invite">
          <FormField
            ...
            readOnly
            right={<ShortId id={invite.inviteId} size="xs" />}
          />
          <FormField
            label="projectInviteId"
            value={shortId(invite.projectInviteId)}
            readOnly
            right={<ShortId id={invite.projectInviteId} size="xs" />}
          />
