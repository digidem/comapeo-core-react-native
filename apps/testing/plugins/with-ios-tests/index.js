// Testing-app-only Expo config plugin. NOT part of the public
// @comapeo/core-react-native API. Consumers of this module never see this
// plugin — it lives under apps/testing/plugins/ purely so that the testing app
// (which doubles as our integration-test harness) can re-inject its test
// target every time `expo prebuild` regenerates apps/testing/ios/.
//
...
const APP_TARGET_NAME = 'corereactnativetesting'
const TEST_TARGET_NAME = 'corereactnativetestingTests'
const TEST_BUNDLE_ID = 'com.comapeo.core.testing.tests'
const IPHONEOS_DEPLOYMENT_TARGET = '15.1'

// Source of truth for the iOS XCTest sources. Kept under apps/testing/tests/ios/
// (rather than bundled with the plugin) to mirror with-android-tests —
// test code for both platforms then lives side-by-side under apps/testing/tests/.
